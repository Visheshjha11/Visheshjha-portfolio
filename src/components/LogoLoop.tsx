...
const useResizeObserver = (callback: () => void, containerRef: React.RefObject<any>, seqRef: React.RefObject<any>) => {
  useEffect(() => {
...
const useImageLoader = (seqRef: React.RefObject<any>, onLoad: () => void, logos: LogoItem[]) => {
  useEffect(() => {
