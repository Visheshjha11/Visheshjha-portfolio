...
class RetroEffectImpl extends Effect {
  ...
  get colorNum() {
    return (this as any).uniforms.get('colorNum')!.value;
  }
  set colorNum(v) {
    (this as any).uniforms.get('colorNum')!.value = v;
  }

  get pixelSize() {
    return (this as any).uniforms.get('pixelSize')!.value;
  }
  set pixelSize(v) {
    (this as any).uniforms.get('pixelSize')!.value = v;
  }
}
